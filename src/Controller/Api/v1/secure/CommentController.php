...
class CommentController extends AbstractController
{
    ...
    /**
     * @Route("list-comments", name="list_comments", methods={"GET"})
     * @return JsonResponse
     */
    ...
    /**
     * @Route("by/article", name="comment_by_article", methods={"GET"})
    ...
    /**
     * @Route("new-comment", name="comment_new", methods={"POST"})
     * @return JsonResponse
     */
